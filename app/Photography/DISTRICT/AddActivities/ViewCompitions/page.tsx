...
// import "../../../../Components/DISTRICT/AddActivities/ViewCompitions/ParticularCompitionParticipants"
...
export default function CompetitionsPage() {
  ...
  const handleClickSubmitId = (id: any) => {
    router.push(`/Photography/DISTRICT/AddActivities/ViewCompitions/ParticularCompition?id=${id}`);
  };
  const handleClickSubmitId2 = (id: any) => {
    router.push(`/Photography/DISTRICT/AddActivities/ViewCompitions/ParticularCompitionParticipants?id=${id}`);
  };
                ...
                >
                  ...
                  <CardContent className="pt-0">
                    <div className="flex gap-2" style={{flexDirection : "column"}}>
                      <Button onClick={() => {handleClickSubmitId(competition._id)}} className="flex-1" variant={competition.isLive ? "default" : "outline"}>
                        <Eye className="h-4 w-4 mr-2" />
                        View Details
                      </Button>
