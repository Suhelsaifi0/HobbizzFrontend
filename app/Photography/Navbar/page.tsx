...
function Navbar() {
  ...
  const gotojoinclub = () => {
    router.push("/Photography/PHOTOGRAPHY/JoinClub")
  }
  ...
  const navOptions: Record<NavType, NavItem[]> = {
    ...
    head: [
      { name: "Home", icon: HomeIcon, action: () => router.push("/Photography/home") },
      { name: "Manage Events", icon: Flag, action: () => router.push("/Photography/DISTRICT/LocalEvents") },
      { name: "Manage Ambassadors", icon: School, action: () => router.push(`/Photography/DISTRICT/ManageAmbassadors`) },
      { name: "Manage Schools", icon: School, action: () => router.push(`/Photography/DISTRICT/ManageSchools`) },
    ],
    ambassador: [
      { name: "Home", icon: HomeIcon, action: () => router.push("/Photography/home") },
      { name: "Local Events", icon: Flag, action: () => router.push("/Photography/DISTRICT/LocalEventsDisplayPage") },
      { name: "Club Info", icon: Sparkles, action: () => router.push("/Photography/DISTRICT/ClubInfo") },
      { name: "Manage Students", icon: School, action: () => router.push("/Photography/DISTRICT/ManageStudents") },
    ],
  }
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <motion.div whileHover={{ scale: 1.05 }} className="flex items-center space-x-2">
              ...
              <span
                onClick={() => router.push("/Photography/home")}
