...
export default function SignIn() {
  ...
  const handleClick1 = () => {
    router.push('/Photography/Auth/SignUp');
  };
  const gotoeditorSignup = () => {
    router.push('/Photography/Auth/EditorSignup');
  };
  const gotoeditorSignin = () => {
    router.push('/Photography/Auth/EditorSignIn');
  };
  ...
  const GotoJudgeSignup = () => {
    router.push('/Photography/Auth/JudgeSignup');
  }
  const GotoJudgeSignin = () => {
    router.push('/Photography/Auth/JudgeSignIn');
  }


  const GotoPrincipleSignUp = () => {
    router.push("/Photography/Auth/PrincipleSignUp")
  }
  const GotoPrincipleSignIn = () => {
    router.push("/Photography/Auth/PrincipleSignIn")
  }
