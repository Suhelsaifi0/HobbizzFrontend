...
export default function SignIn() {
  ...
  const GotoDashBoard = () => {
    router.push('/Photography/EDITOR/EditorDashboard');
  }
  const GotoDashBoardDirector = () => {
    router.push('/Photography/EDITOR/EditorDashboard');
  }
  const GotoDistrictSignup = () => {
    router.push('/Photography/Auth/DistricctSignUp');
  }


  const GotoJudgeDashBoard = () => {
    router.push('/Photography/Judge/JudgeDashBoard');
  }
  ...
  const GotoPrincipleSignUp = () => {
   ...
   const GotoPrincipleDashBoard = () => {
    router.push('/Photography/Principle/PrincipleDashBoard');
  }
