...
// import SignIn from "../../../Components/Auth/PrincipleSignIn"
...
export default function SignUp() {
  ...
  const postData = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/PHOTOPRINCIPLE-signup`, {
        method: "POST",
        headers: {
          ...
          >
            <Card className="backdrop-blur-sm bg-white/95 shadow-2xl border-0">
              <CardHeader className="space-y-1 text-center pb-6">
                ...
                <CardTitle className="text-2xl font-bold text-gray-900">Principle SignUp</CardTitle>
                  ...
                  Terms and Conditions
                    ...
                    >
                      <p className="text-sm text-gray-600">
                        ...
                        <span
                          onClick={() => { router.push("/Components/Auth/PrincipleSignIn") }}
