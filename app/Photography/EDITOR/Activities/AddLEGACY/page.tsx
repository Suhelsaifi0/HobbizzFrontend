...
// import "../../../../Components/EDITOR/Activities/AddLEGACY/Update"
...
const HallOfFameForm = () => {
    ...
    const handleClickSubmitId = (id: any) => {
        router.push(`/Photography/EDITOR/Activities/AddLEGACY/ViewParticularHeritage?id=${id}`);
    };
    const gotoUpdate = (id: any) => {
        router.push(`/Photography/EDITOR/Activities/AddLEGACY/Update?id=${id}`);
    };
    ...
    const handleDelete = async (id: any) => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/club-legacy/${id}`, {
                method: "DELETE",
                headers: {
